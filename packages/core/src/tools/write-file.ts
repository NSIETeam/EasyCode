...
export class WriteFileTool
  ...
  async shouldConfirmExecute(
    ...
    const originalContentForDisplay = originalContent.replace(/\r\n/g, '\n');
    const correctedContentForDisplay = correctedContent.replace(/\r\n/g, '\n');

    const fileDiff = Diff.createPatch(
      fileName,
      originalContentForDisplay,
      correctedContentForDisplay,
      'Current',
      'Proposed',
    ...
    const confirmationDetails: ToolEditConfirmationDetails = {
      ...
      fileName,
      fileDiff,
      originalContent: originalContentForDisplay,
      newContent: correctedContentForDisplay,
  ...
  async execute(
    ...
    const {
      originalContent,
      correctedContent: rawFileContent,
      fileExists,
    ...
    try {
      ...
      const fileContentForDisplay = fileContent.replace(/\r\n/g, '\n');
      const currentContentForDisplay = currentContentForDiff.replace(/\r\n/g, '\n');
      ...
      const displayResult: FileDiff = {
        ...
        newContent: fileContentForDisplay,
      };
